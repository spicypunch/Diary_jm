...
public final class ItemBinding implements ViewBinding {
  ...
  private ItemBinding(@NonNull ConstraintLayout rootView, @NonNull TextView itemContent,
  ...
  public static ItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemBinding((ConstraintLayout) rootView, itemContent, itemImage, itemTitle);
    }
